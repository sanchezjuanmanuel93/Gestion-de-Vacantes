                ...
                <div class="row mb-3">
                        <div class="col-lg-4 col-md-12">
                                <div class="form-inline">
                                        <x-form-group fieldName="creada" fieldDescription="Creada:" :errors="$errors">
                                                <input type="checkbox" name="estado[]" value="creada"
                                                        @if(collect(request()->get('estado'))->contains('creada'))
                                                checked @endif >
                                        </x-form-group>
                                        <x-form-group fieldName="abierta" fieldDescription="Abierta:" :errors="$errors">
                                                <input type="checkbox" name="estado[]" value="abierta"
                                                        @if(collect(request()->get('estado'))->contains('abierta'))
                                                checked @endif>
                                        </x-form-group>
                                        <x-form-group fieldName="cerrada" fieldDescription="Cerrada:" :errors="$errors">
